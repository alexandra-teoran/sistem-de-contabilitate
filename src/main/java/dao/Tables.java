...
public class Tables {
	public static void main(String[] args) {
        try{
            ...
            String tabelIntrare="create table intrare(id_intrare int AUTO_INCREMENT primary key, tip_intrare varchar(200), id_sursa int, data varchar(200), id_categorie int, suma int, foreign key id_sursa_fk (id_sursa) references sursa(id_sursa), foreign key id_categorie_fk (id_categorie) references categorie(id_categorie))";
